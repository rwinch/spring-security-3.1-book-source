...
public class EventMobileDetailsView extends EventMobileDetailsView_Roo_Gwt {
    ...
    private static com.packtpub.springsecurity.events.client.managed.ui.EventMobileDetailsView instance;
    ...
    public static com.packtpub.springsecurity.events.client.managed.ui.EventMobileDetailsView instance() {
        if (instance == null) {
