...
<ul>
    ...
    <li>There are no visible changes to our application. However, we no longer use our CalendarUserDetailsService. Instead we use our CalendarAuthenticationProvider.</li>
