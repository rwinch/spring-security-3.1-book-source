package com.packtpub.springsecurity.events.client.scaffold.place;
 ...
 * {@link com.packtpub.springsecurity.events.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link com.packtpub.springsecurity.events.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link com.packtpub.springsecurity.events.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
