...
public class EventMobileListView extends EventMobileListView_Roo_Gwt {
    ...
    private static com.packtpub.springsecurity.events.client.managed.ui.EventMobileListView instance;
    ...
    public static com.packtpub.springsecurity.events.client.managed.ui.EventMobileListView instance() {
        if (instance == null) {
